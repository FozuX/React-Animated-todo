...
Try the demo on [![Expo Go](./doc/expo-logo.svg)](https://expo.dev/@dhmsbu/animated-todo)
...
after project starting, scan QR using Expo Go(android) or camera app (ios).
Want u project deploy 24/7?, publish you expo and scan QR code or using link.